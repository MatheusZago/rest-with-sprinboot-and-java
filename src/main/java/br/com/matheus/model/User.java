...
public class User implements UserDetails, Serializable {
    ...
    //Fazendo a relação assim pq é uma relação many to many simples
    @ManyToMany(fetch = FetchType.EAGER)  //eager significa que assim que user for carregado via carregar suas permissões tbm
    @JoinTable(name = "user_permission",  //Ta dizendo qual é a "tablea do meio
    ...
    public List<String> getRoles(){ //Tem que fazer essa conversão por causa da UserDetails
